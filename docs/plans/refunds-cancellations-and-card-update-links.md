...
> Status: **PROPOSED** (2026-09-09). Owner: `recharge-orchestrator`. Specialists:
...
|---|---|---|---|
| **R0 — Spec** | `docs/ux/35-refunds.md`, `36-card-update-links.md`, the i18n key list, the accountant's answer to §3.7 | product-ux-architect | Spec approved by the user |
