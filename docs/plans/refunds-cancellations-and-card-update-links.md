...
> Status: **R1–R5 (Woo) + C1–C2 SHIPPED** (2026-09-09) — see
> [docs/reviews/phase-refunds.md](../reviews/phase-refunds.md), plus R5's
> WooCommerce half. What remains: R5's Shopify half (blocked on Shopify's
> protected-customer-data approval), C3 (live verification), and the §3.7
> accounting question.
