...
return [
    ...
    'plan_drawer' => [
        ...
        'activation_help' => 'המחזור הראשון נגבה בקופה, אבל המנוי ממתין בסטטוס "ממתין להפעלה" עד שהלקוח מאשר את הקישור שנשלח אליו במייל. החיוב הבא ייקבע למחזור אחד מיום ההפעלה. לא זמין במסלול Shopify Payments.',
