...
return [
    ...
    'reason' => [
        ...
        'already_requested' => 'המחזור הזה כבר חויב, או שהחיוב עדיין בעיבוד. ראו ב"היסטוריית הזמנות" — ברגע ש-Shopify מאשרת את התשלום, תאריך החיוב הבא מתקדם מעצמו.',
        'awaiting_activation' => 'המנוי ממתין שהלקוח יפעיל אותו. אפשר להפעיל אותו עבורו ב"הפעלה עכשיו".',
    ],
];
