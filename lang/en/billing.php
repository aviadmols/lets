...
return [
    ...
    'settings' => [
        ...
        'self_service' => [
            ...
            'cancel_mode' => 'How cancelling works',
            'cancel_mode_self' => 'One click — the customer cancels themselves',
            'cancel_mode_contact' => 'Through support — the button shows your contact details',
            'cancel_contact_email' => 'Support email for cancellations',
            'cancel_contact_email_help' => 'Left empty, your support address is shown.',
            'cancel_contact_phone' => 'Support phone',
            'cancel_contact_note' => 'What the popup says',
            'cancel_contact_note_help' => 'The sentence a customer reads when they click Cancel. Left empty, a friendly default is shown.',
