...
return [
    ...
    'action' => [
        ...
        'restamp' => 'Re-send to the order',
        'restamp_heading' => 'Re-send this invoice to the store order?',
        'restamp_body' => 'The invoice already exists — nothing new is issued. Its number and link are sent again to the store, so the order screen shows the document.',
        'restamp_queued' => 'Sent. The order will show the invoice shortly.',
    ...
    'reason' => [
        ...
        'not_issued' => 'Only an issued invoice can be re-sent to its order.',
        'no_order' => 'This invoice names no store order, so there is nothing to send it to.',
